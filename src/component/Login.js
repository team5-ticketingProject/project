    ...
    <div>
      ...
      <div class="form">
        ...
        <form>
          ...
          <div class="right">
            <a href="/findIP">아이디/비밀번호 찾기</a>
          </div>
          <div class="easy">
            <p>간편 로그인</p>
            <div class="kdiv">
              <a href="/login">
                <img class="kakao" src="img/kakao.png" alt="카카오" />
              </a>
              <br />
              <a href="/login" class="size">
                카카오 로그인
              </a>
            </div>
            <div class="kdiv">
              <a href="/login">
                <img class="kakao" src="img/naver.png" alt="네이버" />
              </a>
              <br />
              <a href="/login" class="size">
                네이버 로그인
            ...
            <div class="ezlogin">
              ...
              <br />
              <a href="/login">
                <img class="smallimg" src="img/IPIN.png" alt="아이핀" />
              </a>
            </div>
            <div class="ezlogin">
              <a href="/login" class="sizeb">
              ...
              <br />
              <a href="/login">
                <img class="smallimg" src="img/key.png" alt="금융인증서" />
              </a>
            </div>
          </div>
        </form>
