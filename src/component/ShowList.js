  ...
  return (
    <div className="showList">
      <ul className="locationUl">
        <li>
          <button data-values="11" onClick={handle_Location}>서울</button>
        </li>
        <li>
        <button data-values="28,41" onClick={handle_Location}>경기/인천</button>
        </li>
        <li>
        <button data-values="27,47" onClick={handle_Location}>대구/경북</button>
        </li>
        <li>
        <button data-values="26,48" onClick={handle_Location}>부산/경남</button>
        </li>
        <li>
        <button data-values="29,45,46" onClick={handle_Location}>광주/전라</button>
        </li>
        <li>
        <button data-values="50" onClick={handle_Location}>제주</button>
        </li>
      </ul>
      <br></br>
      <br></br>
