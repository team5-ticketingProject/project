...
(2,'회원 가입은 어떻게 하나요?',
' [회원가입] 버튼 선택 > 아이디 및 비밀번호, 약관동의 '),
(3,
'휴대폰 번호를 변경하였습니다. ',
'휴대폰 번호가 변경되었다면 본인인증 변경을 진행해야 합니다.'),
(4,'회원 탈퇴 신청을 하고 싶어요.',
'개인정보 도용 등으로 인한 원치 않은 서비스 탈퇴, 부정 이용 방지 등에 대비하기 위하여 서비스 탈퇴 요청 후 3일간 개인정보를 보관합니다.
서비스 재 이용을 원하시는 경우, 탈퇴 신청 3일 후 서비스 재 가입하여 이용하시기 바랍니다.'),
(5,'예매 시 할인 수단에는 어떤 것들이 있나요?','[신용(체크)카드]
...
(3,'[공지] 10월 시스템 정기점검','점검일시 : 10월 2일(월) 02:00 ~ 08:00 점검이 끝나는 대로 서비스를 정상적으로 재개하도록 하겠습니다.','2023-09-25 09:03:59'),
(4,'[공지] PAYCO 결제서비스 중지 안내','10월 9일(월)부터 PAYCO 결제가 불가능합니다. 불편을 드려 죄송합니다.','2023-10-6 12:00:00'),
(5,'[연극] 괴물 - 대학로 티켓 오픈 안내',
'공연정보
공연 기간 : 2023년 10월 13일(금) ~ 2023년 10월 29일(일)
공연 시간 : 평일 20:00, 토 16:30, 일 15:00
공연 장소 : 단막극장
관람 시간 : 80분','2023-10-10 09:30:25'),
(6,'[공지] 시스템 점검으로 인한 서비스 일시 중단 안내 (11월 8일 (수요일) 00:00 – 08:00)',
'점검이 끝나는 대로 서비스를 정상적으로 재개하도록 하겠습니다. 이용에 불편을 드려 대단히 죄송합니다.','2023-11-06 08:56:08');
